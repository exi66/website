<template>
  <div class="space-y-4 border-b pb-4 mt-8">
    ...
    <div>
      ...
      <div class="flex flex-wrap justify-between gap-2">
        <p class="text-lg text-muted-foreground mt-2">{{ $t("projects.description") }}</p>
  ...
  <div class="flex flex-col">
    ...
    <template v-else-if="queryProjects.length > 0">
      <div v-for="b in queryProjects" :key="b._id" class="border-b grid lg:grid-cols-12 py-6">
        <div class="col-span-1 lg:col-span-2">
          <div class="my-1.5">
...
const queryProjects = computed(() => {
  let result = projects.value.filter(b => b.navigation.publishedAt)
  if (search.value) {
